 ...
 * @author ekaranja
 */
public class DropboxExample1 {

    /**
     * @param args the command line arguments
     */
    
    	private static final String DROP_BOX_APP_KEY = "diyh9l480jxklke";
	private static final String DROP_BOX_APP_SECRET = "s3e6aubrd6mdrxm";
	DbxClient dbxClient;
    ...
    public static void main(String[] args) throws IOException, DbxException {
        // TODO code application logic here
        	...
        	DropboxExample1 javaDropbox = new DropboxExample1();
